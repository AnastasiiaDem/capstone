...
export default function ReserveForm({onSubmit}) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      date: Yup.date().typeError("Please enter a valid date, format: MM/DD/YYYY").required("Date is a required field"),
    ...
    <form onSubmit={(e) => {
      ...
      <div className="mb-6">
        ...
        <input type="text" id="firstName"
               ...
               required/>
        {formik.errors.firstName && formik.touched.firstName && <p className="error" data-role="firstNameError">{formik.errors.firstName}</p>}
      </div>
      <div className="mb-6">
        ...
        {formik.errors.lastName && formik.touched.lastName &&
          <p className="error" data-name="lastNameError"> {formik.errors.lastName}</p>}
      </div>
      <div className="mb-6">
      ...
      <div className="mb-6">
        ...
        {formik.errors.date && formik.touched.date && <p className="error" id="dateError"> {formik.errors.date}</p>}
      </div>
      <div className="mb-6">
        ...
        {formik.errors.time && formik.touched.time && <p className="error" id="timeError"> {formik.errors.time}</p>}
      </div>
      <div className="mb-6">
        ...
        {formik.errors.numberOfGuest && formik.touched.numberOfGuest &&
          <p className="error" id="numberOfGuestsError"> {formik.errors.numberOfGuest}</p>}
      </div>
      <div className="mb-6">
        ...
        {formik.errors.occasion && formik.touched.occasion &&
          <p className="error" id="occasionError"> {formik.errors.occasion}</p>}
      </div>
      <div className="mb-6">
